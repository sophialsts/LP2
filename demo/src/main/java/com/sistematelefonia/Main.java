...
public class Main {
    public static void main(String[] args) {
        ...
        Tempo fimAtual = new Tempo(horaFim,minutoFim,segundoFim);
        ...
        Tempo fimAtual2 = new Tempo(horaFim2,minutoFim2,segundoFim2);
        ...
        System.out.println(novaConta.calcConta("camaçari"));
